...
const btnsTimePeriod = document.querySelectorAll("#btn-timePeriod") as NodeListOf<HTMLElement>
const btnsFilterSubscribed = document.querySelectorAll("#filter-subscribed") as NodeListOf<HTMLElement>
...
btnFilter.addEventListener("click", event => {
    ...
    const specializationValue = selectValue.innerText as "Todos" | specialization
...
function handleButtonsFilter(htmlButtons: NodeListOf<HTMLElement>, typeFilterValue: "timePeriod" | "subscribed") {
